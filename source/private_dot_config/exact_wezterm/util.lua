...
---Note: Stderr will be displayed
---@param cmd string cmd to run
---@param raw boolean? if `true`, returns stdout as raw string, else process it
---@return string stdout processed or raw depending on `raw`
