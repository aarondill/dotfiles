...
function vcontrol:set(brightness, callback)
	self.backend:set(brightness, callback or function()
		self:update()
	end)
end

function vcontrol:up(step, callback)
	self.backend:up(step or self.step, callback or function()
		self:update()
	end)
end

function vcontrol:down(step, callback)
	self.backend:down(step or self.step, callback or function()
		self:update()
	end)
end
